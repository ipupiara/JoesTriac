...
#define RGB_RED    2	/* Offset of Red in an RGB scanline element ********* Value different from default value : 0  ********** */
#define RGB_GREEN  1	/* Offset of Green */
#define RGB_BLUE   0	/* Offset of Blue ********* Value different from default value : 2  ********** */
